...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="btn btn-primary rounded-pill px-4 ms-lg-3" href="{{ route('dashboard') }}">
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="btn btn-primary rounded-pill px-4 ms-lg-3 mt-2 mt-lg-0" href="{{ route('register') }}">
    ...
    <section class="cta-section py-5 text-white text-center" style="padding-top: 5rem !important; padding-bottom: 5rem !important;">
        <div class="container position-relative" style="z-index: 2;">
            ...
            @else
                <a href="{{ route('dashboard') }}" class="btn btn-hero btn-hero-primary btn-lg">
                    <i class="bi bi-grid-fill me-2"></i>Eiti į valdymo skydą
                </a>
            @endguest
        </div>
    ...
    <footer class="py-5">
        <div class="container">
            ...
            <div class="text-center text-white-50">
                <p class="mb-0">&copy; {{ date('Y') }} MOPA. Visos teisės saugomos.</p>
            </div>
        </div>
    </footer>
