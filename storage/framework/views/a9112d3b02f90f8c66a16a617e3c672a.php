...
<body>
  <nav class="navbar navbar-light sticky-top">
    <div class="container">
      ...
      <div class="d-flex gap-2">
        <a href="<?php echo e(route('schools.index')); ?>" class="btn btn-outline-primary btn-sm"><i class="bi bi-building"></i> Mokyklos</a>
        <?php if(session('active_school_id')): ?>
          <a href="<?php echo e(route('schools.timetables.index', session('active_school_id'))); ?>" class="btn btn-primary btn-sm"><i class="bi bi-calendar3"></i> Tvarkaraščiai</a>
        <?php else: ?>
          <a href="<?php echo e(route('schools.index')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-calendar3"></i> Tvarkaraščiai</a>
        <?php endif; ?>
      </div>
    </div>
  </nav>
  ...
  <main>
    ...
    <section class="hero-section">
      <div class="hero-content" data-aos="fade-up">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap" data-aos="zoom-in" data-aos-delay="200">
          <a href="<?php echo e(route('schools.index')); ?>" class="btn btn-hero"><i class="bi bi-rocket-fill"></i> Pradėti</a>
          <?php if(session('active_school_id')): ?>
            <a href="<?php echo e(route('schools.timetables.index', session('active_school_id'))); ?>" class="btn btn-hero-secondary"><i class="bi bi-calendar3"></i> Mano tvarkaraščiai</a>
          <?php else: ?>
            <a href="<?php echo e(route('schools.index')); ?>" class="btn btn-hero-secondary"><i class="bi bi-building"></i> Mano mokyklos</a>
          <?php endif; ?>
        </div>
      </div>
    </section>
    ...
    <section class="cta-section">
      <div class="container">
        ...
        <a href="<?php echo e(route('schools.index')); ?>" class="btn btn-hero" data-aos="zoom-in" data-aos-delay="200">
  ...
  <footer>
    <div class="container text-center">
      ...
      <small class="text-muted">© <?php echo e(date('Y')); ?> MOPA. Visos teisės saugomos. | 
